...
# Task22 calibration on an unmodified scheduling policy:
...
TASK22_PYTHON="$PYTHON_BIN" MODEL_DIR="$MODEL_DIR" DATA_DIR="$DATA_DIR" \
    "$REPO/scripts/task22/preflight_clean_main_calibration.sh" --formal \
...
payload = {
    ...
    "measurement_contract": {
        "purpose": "latest-main phase-elastic and operator calibration",
